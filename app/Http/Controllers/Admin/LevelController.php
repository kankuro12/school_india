...
class LevelController extends Controller
{
    ...
    public function add(Request $request){
        ...
        ->with('message','Level Added Sucessfully');
    }
    public function update(Request $request){
        ...
        $level->employee_id=$request->employee_id==-1?null:$request->employee_id;
        $level->save();
        return redirect()->back()->with('message','Level Updated Sucessfully');
    }
    ...
    public function sectionAdd(Request $request){
        ...
        $section->save();
        return redirect()->back()
        ->with('message','Section Added Sucessfully');
    }
    public function sectionUpdate(Request $request){
        ...
        $section->employee_id=$request->employee_id==-1?null:$request->employee_id;
        $section->save();
        return redirect()->back()->with('message','Section Updated Sucessfully');
    }
